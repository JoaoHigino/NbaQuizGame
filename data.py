...
QUESTIONS = {
    ...
    "Who has the most games played in NBA history?: ": "B",
    "Who has the biggest team winning streak?: ": "B",
    "Who has the most turnovers in an NBA game?": "C",
    "Which one was 1st pick on NBA draft?: ": "C",
    "Who has the best career free throw percent?": "A",
    "Who has the worst career free throw percent?": "D",
...
OPTIONS = [
    ...
    ["A. R.Westbrook", "B. G.Arenas", "C. J.Kidd", "D. J.Harden"],
    ["A. K.Durant", "B. S.Curry", "C. B.Griffin", "D. T.Chandler"],
    ["A. S.Curry", "B. S.Nash", "C. M.Price", "D. P.Stojaković"],
    ["A. S. ONeal", "B. Dennis Rodman", "C. Chris Dudley", "D. Ben Wallace"],
